    ...
    return Row(
      ...
      children: <Widget>[
        _CategoryButton(
          ...
          selected: selectedCategory == PlaceCategory.dormitary,
          onCategoryChanged: onCategoryChanged,
        ),
        _CategoryButton(
          category: PlaceCategory.cafes,
          selected: selectedCategory == PlaceCategory.cafes,
          onCategoryChanged: onCategoryChanged,
        ),
        _CategoryButton(
          category: PlaceCategory.offices,
          selected: selectedCategory == PlaceCategory.offices,
          onCategoryChanged: onCategoryChanged,
        ),
      ],
    );
