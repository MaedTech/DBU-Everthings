...
class PlaceMapState extends State<PlaceMap> {
  static BitmapDescriptor _getPlaceMarkerIcon(PlaceCategory category) {
    switch (category) {
      case PlaceCategory.dormitary:
        return BitmapDescriptor.defaultMarker;
        break;
      case PlaceCategory.cafes:
        return BitmapDescriptor.defaultMarker;
        break;
      case PlaceCategory.offices:
      default:
        return BitmapDescriptor.defaultMarker;
    }
  }
...
class _CategoryButtonBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Visibility(
      visible: visible,
      child: Container(
        padding: const EdgeInsets.fromLTRB(0.0, 1
        , 0.0, 0.0),
        ...
        child: ButtonBar(
          ...
          children: <Widget>[
            RaisedButton(
            shape: StadiumBorder(),
              color: selectedPlaceCategory == PlaceCategory.dormitary
                  ? Colors.black12
                  : Colors.blue,
              child: const Text(
              ...
              onPressed: () => onChanged(PlaceCategory.dormitary),
            ),
            RaisedButton(
              
              shape: StadiumBorder(),
              color: selectedPlaceCategory == PlaceCategory.cafes
                  ? Colors.black12
                  : Colors.blue,
              child: const Text(
                'Cafes',
              ...
              onPressed: () => onChanged(PlaceCategory.cafes),
            ),
            RaisedButton(
              shape: StadiumBorder(),
              color: selectedPlaceCategory == PlaceCategory.offices
                  ? Colors.black12
                  : Colors.blue,
              child: const Text(
                'Offices',
              ...
              onPressed: () => onChanged(PlaceCategory.offices),
            ),
...
class _MapFabs extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      margin: const EdgeInsets.only(top: 60.0, right: 12.0),
      child: Visibility(
        visible: visible,
        child: Column(
