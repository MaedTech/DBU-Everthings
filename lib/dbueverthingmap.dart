...
import 'package:dbueverything/aboutus.dart';
...
class DbuEverythingMap extends StatefulWidget {
  @override
  _DbuEverythingMapState createState() => _DbuEverythingMapState();
}
     ...
     drawer: new Drawer(
        ...
        child: ListView(
          children: <Widget>[
            ...
            new ListTile(
              title: new Text('Ptofile',style: new TextStyle(fontSize: 18.0),),
              onTap: () {
            ...
            new ListTile(
              title: new Text('Dashboard', style: new TextStyle(fontSize: 18.0),),
                onTap: () {
                Navigator.of(context).pop();
                Navigator.push(
                    context,
             ...
             new ListTile(
              title: new Text('Maed Tech', style: new TextStyle(fontSize: 18.0),),
                onTap: () {
                Navigator.of(context).pop();
                Navigator.push(
                    context,
             ...
             new ListTile(
              title: new Text('Team Members', style: new TextStyle(fontSize: 18.0),),
                onTap: () {
                Navigator.of(context).pop();
                Navigator.push(
                    context,
            ...
            Divider(),
             new ListTile(
              title: new Text('Setting', style: new TextStyle(fontSize: 18.0),),
                onTap: () {
                Navigator.of(context).pop();
                Navigator.push(
                    context,
...
class AppState {
  const AppState({
    ...
    this.selectedCategory = PlaceCategory.dormitary,
